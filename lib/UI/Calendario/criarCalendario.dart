            ...
            child: Text(
              ...
              Padding(
                ...
                child: TextFormField(
                    ...
                    validator: (value) {
                      if (value.isEmpty)
                        return "Insira o nome do calendário";
                      else
                        return null;
                    }),
              ),
              ...
              Container(
                child: Row(
                  children: <Widget>[
                    Padding(
                      padding: EdgeInsets.fromLTRB
                        (_LarguraTela*0.08, _alturaTela * 0.05,_LarguraTela*0.03, _alturaTela*0.05),
                      child: Text(
                        "Cliente",
                        style: TextStyle(
                            color: Color(0xFF0f0f0f),
              ...
              Padding(
                padding: EdgeInsets.fromLTRB(0, 0, _alturaTela*0.23, 0),
                child: Text(
                  "Procedimentos",
                  style: TextStyle(
                      color: Color(0xFF7697ce),
